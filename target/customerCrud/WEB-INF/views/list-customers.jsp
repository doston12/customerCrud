...
<div class="wrapper">
			...
			<ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
					...
					<ul class="treeview-menu">
						<li class="active"><a href="/customer/list"><i class="fa fa-circle-o"></i>Customers</a></li>
						<li><a href="/employee/list"><i class="fa fa-circle-o"></i>Employees</a></li>
	...
	<div class="content-wrapper">
		<section class="content-header">
			<h1>
				Data Tables
				<small>customers table</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="/customer/index"><i class="fa fa-dashboard"></i> Home</a></li>
				<li><a href="/customer/index">Tables</a></li>
				...
				<div class="col-xs-12">
					<div>
						<button type="button" class="btn btn-success btn-sm" style="margin-bottom: 5px"
								onclick="window.location.href='showForm'; return false;" title="Add">
							<i class="fa fa-plus fa-lg" aria-hidden="true"></i>
						</button>
						<c:url var="addLink" value="/customer/showForm">
						</c:url>
									...
									<c:forEach var="tempCustomer" items="${customers}">
										...
										<tr>
											...
											<td style="align-content: center; ">
												<c:if test="${tempCustomer.gender == 'MALE'}">
												...
												<c:if test="${tempCustomer.gender=='FEMALE' }">
													<i class="fa fa-female fa-lg" style="padding-left: 40%;"
													   aria-hidden="true"></i>
												</c:if>
											</td>
											<td>
												<fmt:formatDate value="${tempCustomer.birthDate}" type="date"></fmt:formatDate>
